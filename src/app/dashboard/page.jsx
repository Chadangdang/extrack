"use client";
import { useRouter } from "next/navigation"; // <- IMPORTANT: add this
...
export default function DashboardPage() {
  ...
  // navigate to chartdetail page on click
      ...
      <div className="mt-8 w-72 border border-[#cbb89d] bg-[#f9f3ec] rounded-md p-4 text-left">
        ...
        <ul className="space-y-2 text-sm">
          <li className="flex justify-between items-center">
            ...
            <span className="bg-[#7b93ff] text-white text-xs px-2 py-0.5 rounded">
              Bill
            </span>
          </li>
          <li className="flex justify-between items-center">
            <span>2 Clothes</span>
            <span className="bg-[#c5a3e8] text-white text-xs px-2 py-0.5 rounded">
              Shopping
            </span>
          </li>
          <li className="flex justify-between items-center">
            <span>3 Noodles</span>
            <span className="bg-[#f3a7d3] text-white text-xs px-2 py-0.5 rounded">
              Food
            </span>
          </li>
          <li className="flex justify-between items-center">
            <span>4 Salary Oct25</span>
            <span className="bg-[#9cd89c] text-white text-xs px-2 py-0.5 rounded">
              Salary
            </span>
          </li>
        </ul>

        <div className="text-right text-[#8b4f21] text-xs mt-2 cursor-pointer hover:underline"
